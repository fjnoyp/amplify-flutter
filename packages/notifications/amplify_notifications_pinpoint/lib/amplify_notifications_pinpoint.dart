...
library amplify_notifications_pinpoint;
...
/// {@endtemplate}
abstract class AmplifyNotificaitonsPinpoint extends NotificationsPluginInterface {
  /// {@macro amplify_analytics_pinpoint.amplify_analytics_pinpoint}
  factory AmplifyNotificaitonsPinpoint() {
  ...
  @protected
  AmplifyNotificaitonsPinpoint.protected();
}
