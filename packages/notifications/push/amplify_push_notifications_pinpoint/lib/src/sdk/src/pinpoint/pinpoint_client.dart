...
import 'package:amplify_push_notifications_pinpoint/src/sdk/src/pinpoint/model/update_endpoint_response.dart'
    as _i7;
import 'package:amplify_push_notifications_pinpoint/src/sdk/src/pinpoint/operation/put_events_operation.dart'
    as _i6;
...
class PinpointClient {
  ...
  _i3.SmithyOperation<_i4.PutEventsResponse> putEvents(
    _i5.PutEventsRequest input, {
    _i1.AWSHttpClient? client,
  }) {
    return _i6.PutEventsOperation(
      region: _region,
      baseUri: _baseUri,
  ...
  _i3.SmithyOperation<_i7.UpdateEndpointResponse> updateEndpoint(
    _i8.UpdateEndpointRequest input, {
    _i1.AWSHttpClient? client,
  }) {
    return _i9.UpdateEndpointOperation(
      region: _region,
      baseUri: _baseUri,
      credentialsProvider: _credentialsProvider,
    ).run(
