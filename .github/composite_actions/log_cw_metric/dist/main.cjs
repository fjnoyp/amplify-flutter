...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    logMetric() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t3, t4, matrixValues, githubToken, t5, isFailed, failingStep, metricName, testType, workingDirectory, categories, category, _i, cat, framework, flutterDartChannel, dartVersion, flutterVersion, dartCompiler, platform, platformVersion, value, t6, t7, cloudArgs, t1, t2, jobStatus, inputValue, matrixRawInput, jobIdentifier;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              jobIdentifier = A._asString(t2._as(t2._as(t1.github).context).job);
