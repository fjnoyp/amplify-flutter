...
Future<void> logMetric() async {
  // JOB
  // this prints the job name
  // but not actualy matrix identifier
  //print('job: ${github.context.job}');

  // Notes:
  // jobStatus - Cannot get job status as that is in separate job.context.jobStatus
  // jobIdentifier - is job name + matrix values (Only available in matrix context)
  // This is all unnecessary if github just provided job id
  //
  // githubToken - only available within job context
